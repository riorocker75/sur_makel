         ...
         <div class="card">
              <div class="card-header">
                ...
                <div class="float-right">
                  <a href="{{url('/dashboard/surat-masuk/add')}}" class="btn btn-primary">Tambah Surat Masuk</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                {{-- filter tanggal cetak --}}
        <form action="{{url('/dashboard/cetak/surat-masuk')}}" method="post">
                @csrf
                <div class="row">
                  ...
                  <tbody>
                      ...
                      @foreach ($data as $dt)
                           <tr>
                                ...
                                <td>
                                    <a href="{{url('/dashboard/surat-masuk/edit/'.$dt->id.'')}}" class="btn btn-warning">Ubah</a>
                                <a href="{{url('/dashboard/surat-masuk/edit/'.$dt->id.'')}}" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                      @endforeach
