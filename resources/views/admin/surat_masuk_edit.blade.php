    ...
    <section class="content">
      ...
      <div class="container-fluid">
         <div class="card">
              ...
              <div class="card-body">
                  @foreach ($data as $dt)
                <form action="{{ url('/dashboard/surat-masuk/update') }}" method="post">
                       @csrf  
                       @method('POST')
                ...
                <div class="row">
                 <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="tgl_masuk" value="{{date('Y-m-d',strtotime($dt->tanggal_surat))}}"required>
                            </div>
                            <div class="form-group">
